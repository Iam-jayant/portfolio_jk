export default function BlogCreatingNetflixInspiredPortfolio() {
  return (
    <main className="container mx-auto py-20 px-4 max-w-3xl">
      <span className="inline-block px-3 py-1 rounded-full bg-pink-500 text-white text-xs font-semibold mb-2">
        Design
      </span>
      ...
      <section>
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">🧰 The No Code Days: Wix, WordPress, and Blogger</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">When I Finally Wrote My First Line of Code</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">What I Have Built Since Then</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">What I Learned Through It All</h2>
        <p className="mb-4">
